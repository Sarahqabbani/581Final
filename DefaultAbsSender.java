...
public abstract class DefaultAbsSender extends AbsSender {
    ...
    protected DefaultAbsSender(DefaultBotOptions options) {
        ...
        requestConfig = getConfig(configFromOptions);
    }

    private RequestConfig getConfig(RequestConfig configFromOptions) {
        final RequestConfig requestConfig = null;
    ...
    public final Message execute(SendDocument sendDocument) throws TelegramApiException {
        ...
        try {
            ...
            ifSendDocExtracted(sendDocument, builder);
    ...
    private void ifSendDocExtracted(SendDocument sendDocument, MultipartEntityBuilder builder) throws JsonProcessingException {
    ...
    public final Message execute(SendPhoto sendPhoto) throws TelegramApiException {
        ...
        try {
            ...
            ifSendPhotoExtracted(sendPhoto, builder);
            HttpEntity multipart = builder.build();
            httppost.setEntity(multipart);
    ...
    private void ifSendPhotoExtracted(SendPhoto sendPhoto, MultipartEntityBuilder builder) throws JsonProcessingException {
    ...
    public final Message execute(SendVideo sendVideo) throws TelegramApiException {
        ...
        try {
            ...
            ifSendVideoExtracted(sendVideo, builder);
    ...
    private void ifSendVideoExtracted(SendVideo sendVideo, MultipartEntityBuilder builder) throws JsonProcessingException {
    ...
    public final Message execute(SendVideoNote sendVideoNote) throws TelegramApiException {
        ...
        try {
            ...
            ifSendVideoNoteExtracted(sendVideoNote, builder);
            HttpEntity multipart = builder.build();
            httppost.setEntity(multipart);
    ...
    private void ifSendVideoNoteExtracted(SendVideoNote sendVideoNote, MultipartEntityBuilder builder) throws JsonProcessingException {
    ...
    @Override
    public List<Message> execute(SendSticker sendSticker) throws TelegramApiException {
        ...
        try {
            ...
            // Cascaded the getSticker() function to InputFile
            addInputFile(builder, (InputFile) sendSticker.getSticker(), SendSticker.STICKER_FIELD, true);
    ...
    public final Message execute(SendAudio sendAudio) throws TelegramApiException {
        ...
        try {
            ...
            ifSendAudioExtracted(sendAudio, builder);
    ...
    private void ifSendAudioExtracted(SendAudio sendAudio, MultipartEntityBuilder builder) throws JsonProcessingException {
    ...
    public final Message execute(SendVoice sendVoice) throws TelegramApiException {
        ...
        try {
            ...
            ifSendVoiceExtracted(sendVoice, builder);
            HttpEntity multipart = builder.build();
            httppost.setEntity(multipart);
    ...
    private void ifSendVoiceExtracted(SendVoice sendVoice, MultipartEntityBuilder builder) throws JsonProcessingException {
    ...
    public Message execute(SendAnimation sendAnimation) throws TelegramApiException {
        ...
        try {
            ...
            ifSendAnimationExtracted(sendAnimation, builder);
            HttpEntity multipart = builder.build();
            httppost.setEntity(multipart);
    ...
    private void ifSendAnimationExtracted(SendAnimation sendAnimation, MultipartEntityBuilder builder) throws JsonProcessingException {
    ...
    @Override
    public CompletableFuture<List<Message>> executeAsync(SendSticker sendSticker) {
